...
export default class RecieverDetailsScreen extends Component{
  constructor(props){
    ...
    this.state={
      ...
      item_name_toGive        : this.props.navigation.getParam('details')["item_name_toGive"],
      item_name_toGet        : this.props.navigation.getParam('details')["item_name_toGet"],
        ...
        <View style={styles.container}>
          <View style={{flex:0.1}}>
            <Header
              ...
              centerComponent={{ text:"Barter Items", style: { color: '#90A5A9', fontSize:20,fontWeight:"bold", } }}
          ...
          <View style={{flex:0.3}}>
            <Card
              ...
              >
              <Card >
                <Text style={{fontWeight:'bold'}}>Name : {this.state.item_name_toGive}</Text>
              </Card>
              <Card >
                <Text style={{fontWeight:'bold'}}>Name : {this.state.item_name_toGet}</Text>
              </Card>
              <Card>
